...
\begin{itemize}
\item Posee 8 registros de 4 bytes. Ellos son: ZERO, siempre vale cero. PC indica qu\'e instrucci\'on es la pr\'oxima a ejecutar (de la lista de instrucciones). SP Apunta al tope de la pila. R0,..,R3 son registro de uso general y FLAGS contiene bits de estado (resultado de operaciones, comparaciones, etc).
